...
**Behaviour:** Stores details of the reaction removed event including burst status, reaction object, the user who removed the reaction, member, original message, channel and server. Then continues with the next actions.
